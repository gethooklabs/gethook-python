...
class AccountBootstrapData(BaseModel):
    """
    AccountBootstrapData
    """ # noqa: E501
    account: Account
    api_key: APIKeyWithSecret
    __properties: ClassVar[List[str]] = ["account", "api_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "api_key": APIKeyWithSecret.from_dict(obj["api_key"]) if obj.get("api_key") is not None else None
        })
        return _obj
