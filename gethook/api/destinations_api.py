...
class DestinationsApi:
    ...
    def list_destination_presets(
        ...
        _param = self._list_destination_presets_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_destination_presets_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DestinationPreset]]:
        """List destination presets
    ...
    @validate_call
    def list_destination_presets_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_destination_presets_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/destination-presets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rotate_destination_secret(
        self,
        id: Annotated[StrictStr, Field(description="Destination UUID")],
        body: Annotated[Dict[str, Any], Field(description="New signing secret")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Destination UUID (required)
        :type id: str
        :param body: New signing secret (required)
        :type body: object
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rotate_destination_secret_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rotate_destination_secret_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Destination UUID")],
        body: Annotated[Dict[str, Any], Field(description="New signing secret")],
        _request_timeout: Union[
    ...
    @validate_call
    def rotate_destination_secret_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Destination UUID")],
        body: Annotated[Dict[str, Any], Field(description="New signing secret")],
        _request_timeout: Union[
    ...
    def _rotate_destination_secret_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/destinations/{id}/rotate-secret',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
