...
class AuthApi:
    ...
    def login_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountBootstrapData]:
        """Login with email and password
    ...
    def register(
        self,
        register_request: Annotated[RegisterRequest, Field(description="Registration details")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param register_request: Registration details (required)
