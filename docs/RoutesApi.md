...
with gethook.ApiClient(configuration) as api_client:
    ...
    api_instance = gethook.RoutesApi(api_client)
    create_route_request = gethook.CreateRouteRequest() # CreateRouteRequest | Route config

    try:
        # Create route
        api_response = api_instance.create_route(create_route_request)
...
with gethook.ApiClient(configuration) as api_client:
    ...
    try:
        # List routes
        api_response = api_instance.list_routes()
        print("The response of RoutesApi->list_routes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoutesApi->list_routes: %s\n" % e)
```
